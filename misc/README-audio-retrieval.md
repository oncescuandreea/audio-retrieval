...
| Experts | Task | R@1 | R@5 | R@10 | R@50 | MdR | MnR | Geom | params | Links |
| ----- | ---- | --- | --- | ---- | ---- | --- | --- | ----- | -- | -- |
| CE - VGGish + VGGSound   | t2v  | {{clotho-train-vggish-vggsound-finetuned.geomt2v}} | {{clotho-train-vggish-vggsound-finetuned.params}} | [config]({{clotho-train-vggish-vggsound-finetuned.config}}), [model]({{clotho-train-vggish-vggsound-finetuned.model}}), [log]({{clotho-train-vggish-vggsound-finetuned.log}}) |
| CE - VGGish + VGGSound    | v2t  | {{clotho-train-vggish-vggsound-finetuned.geomv2t}} | {{clotho-train-vggish-vggsound-finetuned.params}} | [config]({{clotho-train-vggish-vggsound-finetuned.config}}), [model]({{clotho-train-vggish-vggsound-finetuned.model}}), [log]({{clotho-train-vggish-vggsound-finetuned.log}}) |
| MoEE - VGGish + VGGSound   | t2v  | {{clotho-train-vggish-vggsound-moee-finetuned.geomt2v}} | {{clotho-train-vggish-vggsound-moee-finetuned.params}} | [config]({{clotho-train-vggish-vggsound-moee-finetuned.config}}), [model]({{clotho-train-vggish-vggsound-moee-finetuned.model}}), [log]({{clotho-train-vggish-vggsound-moee-finetuned.log}}) |
| MoEE - VGGish + VGGSound    | v2t  | {{clotho-train-vggish-vggsound-moee-finetuned.geomv2t}} | {{clotho-train-vggish-vggsound-moee-finetuned.params}} | [config]({{clotho-train-vggish-vggsound-moee-finetuned.config}}), [model]({{clotho-train-vggish-vggsound-moee-finetuned.model}}), [log]({{clotho-train-vggish-vggsound-moee-finetuned.log}}) |
